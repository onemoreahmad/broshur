    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex gap-2">
        <span>
            ...
            @if ($paginator->onFirstPage())
                <button type="button"
                    class="rounded-lg border px-3 py-2 bg-white  text-sm text-gray-700 hover:bg-gray-100 disabled:bg-gray-50 disabled:opacity-75 disabled:cursor-not-allowed disabled:text-gray-500"
                    disabled>
                    {{ __('Prev') }}
                </button>
            @else
