<div class="bg-stone-300  min-h-screen pt-10 lg:pt-12 px-1 lg:px-0">
    ...
    {{-- <div class="bg-stone-100x min-h-screen -mt-10 z-50 relative">
    ...
    {{-- <section class="px-4 mx-auto max-w-7xl mt-12 lg:mt-20">
        <div class="rounded-[28px] bg-white shadow-sm ring-1 ring-black/5 p-4 sm:p-6 lg:p-8">
            <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6 auto-rows-[130px] sm:auto-rows-[160px] lg:auto-rows-[180px]">
                ...
                <!-- Manage Cards (wide) -->
                <div class="col-span-12 md:col-span-6 lg:col-span-7 row-span-2 rounded-3xl bg-pink-100 p-6 sm:p-7 lg:p-8 flex items-center justify-between">
                    <div>
                ...
                <div class="col-span-12 lg:col-span-6 row-span-3 rounded-3xl bg-orange-100 p-6 sm:p-7 lg:p-8 flex items-center justify-between">
                    <div>
                ...
                <!-- Find, Compare & Apply -->
                <div class="col-span-12 lg:col-span-6 row-span-3 rounded-3xl bg-sky-100 p-6 sm:p-7 lg:p-8 flex items-center justify-between">
                    <div>
