    ...
    <div class="">
        ...
        <div v-else>
            ...
            <section v-if="form.active" class="flex flex-col gap-1">
                ...
                <div class="divider text-xs">قائمة التقييمات</div>
                ...
                >
                    ...
                    <div class="flex items-center justify-between mb-3">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button @click="removeReview(index)" class="btn btn-xs btn-soft btn-error">
                    ...
                    <UiToggle :name="`reviews.${index}.active`" label="تفعيل التقييم" v-model="review.active" />

                    <!-- Review Form -->
                    <div v-if="review.active" :id="`review-panel-${index}`" XXv-show="!collapsed[index]" class="mt-1 grid grid-cols-1 gap-1">
                        <UiInput :name="`reviews.${index}.client_name`" label="اسم العميل" v-model="review.client_name" placeholder="اسم العميل" />
                        <UiInput :name="`reviews.${index}.client_email`" label="البريد الإلكتروني" v-model="review.client_email" placeholder="البريد الإلكتروني" />
                        <UiInput :name="`reviews.${index}.client_phone`" label="رقم الهاتف" v-model="review.client_phone" placeholder="رقم الهاتف" />
                    
 
                        <!-- Score -->
                        <UiField label="التقييم" :name="`reviews.${index}.score`">
                            <div class="flex items-center gap-2"> 
                                <button 
                                    v-for="star in 5" 
                                    :key="star"
                        ...
                        <UiTextarea :name="`reviews.${index}.review_text`" label="نص التقييم" v-model="review.review_text" placeholder="نص التقييم" />
