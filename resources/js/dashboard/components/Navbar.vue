...
<nav class="bg-white pt-1x">
        <div class="flex items-center gap-x-px font-semibold max-w-7xl justify-between lg:justify-start overflow-x-auto mx-auto px-px lg:px-0 divide-x-reverse divide-xXX divide-base-400/20 [&amp;::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <RouterLink :to="{ name: 'home' }" title="" class="lg:w-fullx xshrink-0 flex w-full px-2 py-3 gap-x-2 items-center justify-center lg:w-auto lg:px-5 lg:shrink" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'content' }" title="" class="lg:w-fullx xshrink-0 flex w-full px-2 py-3 gap-x-2 items-center justify-center lg:w-auto lg:px-5 lg:shrink" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'design' }" title="" class="lg:w-fullX xshrink-0 lg:shrink justify-center flex items-center w-full lg:w-auto gap-x-2 lg:px-5 px-2 py-3" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'share' }" title="" class="lg:w-fullX xshrink-0 lg:shrink justify-center flex items-center w-full lg:w-auto gap-x-2 lg:px-5 px-2 py-3" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'settings' }" title="" class="lg:w-fullX xshrink-0 lg:shrink justify-center flex items-center w-full lg:w-auto gap-x-2 lg:px-5 px-2 py-3" activeClass="bg-base-200">
