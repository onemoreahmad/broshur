...
<nav class="bg-white pt-1x">
        <div class="flex items-center gap-x-px font-semibold max-w-7xl justify-between lg:justify-start overflow-x-auto mx-auto px-px lg:px-0 divide-x-reverse divide-xXX divide-base-400/20 [&amp;::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <RouterLink :to="{ name: 'design' }" title="" class="flex flex-col md:flex-row w-full px-2 py-3 gap-2 items-center justify-center lg:w-auto lg:px-5 lg:shrink" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'share' }" title="" class="flex flex-col md:flex-row w-full px-2 py-3 gap-2 items-center justify-center lg:w-auto lg:px-5 lg:shrink" activeClass="bg-base-200">
            ...
            <RouterLink :to="{ name: 'settings' }" title="" class="flex flex-col md:flex-row w-full px-2 py-3 gap-2 items-center justify-center lg:w-auto lg:px-5 lg:shrink" activeClass="bg-base-200">
