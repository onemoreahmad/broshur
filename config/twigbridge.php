...
return [
    ...
    'twig' => [
         ...
         */
        'globals' => [
            'imageUrl' => env('imageUrl', 'http://catalog.test/image'),

            // globlas don't work in twig-components (x-header) .. so, use Facade instead ..
            // hmmm dont care about twig-components for now 
 
            // 'catalog' => \Catalog\Storefront\Twig\Tenant::class,
        ],
    ],
    ...
    'extensions' => [
        ...
        'facades' => [
            'site'       =>  'App\Twig\Site',
            'page'          =>  'App\Twig\Page',
            'blogPage'          =>  'App\Twig\BlogPage',
            'blogPost'          =>  'App\Twig\BlogPost',
            'menuItem'          =>  'App\Twig\MenuItem',
        ],
        ...
        'functions' => [
            'dd',
            'tenant', // remove later when fix default theme
            'user',
            'member',
            // 'option',
            // 'themeMedia',
