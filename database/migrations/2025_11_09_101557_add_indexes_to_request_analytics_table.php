...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::connection($connection)->table($tableName, function (Blueprint $table) {
            ...
            $table->index(['tenant_id', 'visited_at', 'session_id']);
            $table->index(['tenant_id','path', 'visited_at']);
            $table->index(['tenant_id','browser', 'visited_at']);
            $table->index(['tenant_id','operating_system', 'visited_at']);
